...
from ray.rllib.algorithms.sac import SACConfig  # Use SAC instead of CPO
...
# Configure SAC with constraints
config = (
    SACConfig()  # Use SAC instead of CPO
    .environment("CompilerGymEnv")
    .framework("torch")  # SAC typically uses PyTorch
    .training(
        gamma=0.99,
        lr=3e-4,
